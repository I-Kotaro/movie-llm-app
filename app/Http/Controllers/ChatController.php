...
class ChatController extends Controller
{
    ...
    public function ask(Request $request)
    {
        ...
        try {
            ...
            $finalPrompt .= "5. general_reply（チャットの返答文）を作成する際の【絶対ルール】:\n";
            $finalPrompt .= "   - 単なる挨拶や「ご紹介します！」といった薄い定型文は絶対に禁止します。\n";
            $finalPrompt .= "   - 必ず【提案する映画のうち1〜2作品の具体的なタイトル】を文章の中に組み込んでください。\n";
            $finalPrompt .= "   - 「なぜその映画が今回のユーザーの要望（気分やシチュエーション）に合っているのか」、映画の具体的な魅力に触れながらコンシェルジュ独自の視点で語ってください。\n";
            $finalPrompt .= "   - 毎回オリジナリティ溢れる、人間らしく温かみのあるトーンで出力してください。\n";
            $finalPrompt .= "{\n";
            $finalPrompt .= "  \"general_reply\": \"（上記の絶対ルールに従った、具体的な映画タイトルと選定理由を含む魅力的な提案文を出力）\"\n";
            $finalPrompt .= "}\n";
